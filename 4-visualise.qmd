...
The dendrogram can be plotted by node depth or length via the *Tree* button on the left under the zoom/pan panel. This menu also allows you to adjust the width of tree branches and to change highlighting settings.
