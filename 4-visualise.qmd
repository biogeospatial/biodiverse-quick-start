...
![](images/image4.1.png). **new screenshot needed**
...
![](images/image4.2.png) **new screenshots needed**
...
![](images/image4.3.png) **new screenshots needed**
...
![](images/image4.4.png) **new screenshots needed**
...
The tree is generally a representation of
the phylogenetic similarities between labels, although it could be used for anything that uses such a structure. In this pane, you should see
two sections (assuming a tree object is selected in the main toolbar at the top of the window). The upper section displays the relationship
between labels as a dendrogram.

**new screenshot needed**

The dendrogram can be plotted by node depth or
length via the *Tree* button on the left under the zoom/pan panel. This menu also allows you to adjust the width of tree branches and to change
...
![](images/image4.5.png) **new screenshot needed**
...
![](images/image4.6.png) **new screenshot needed**
...
![](images/image4.7.png)  **new screenshot needed**
...
![](images/image4.8.png)  **new screenshot needed**